...
import { ChevronRight, TrendingUp, Zap, Award, ArrowDown } from "lucide-react";
      ...
      <div className="relative max-w-7xl mx-auto px-4 py-12 md:py-20">
        ...
        <div className={`text-center mb-16 transition-all duration-1000 ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"}`}>
          <div className="inline-flex items-center gap-2 px-4 py-2 bg-sky-500/10 border border-sky-500/20 rounded-full mb-4">
            ...
            <span className="text-sm font-semibold text-sky-300">Men's Collection</span>
          </div>
          <h1 className="text-5xl md:text-6xl lg:text-7xl font-black text-slate-50 mb-4 tracking-tight">
            For the <span className="text-transparent bg-clip-text bg-gradient-to-r from-sky-400 to-blue-500">Modern Man</span>
          </h1>
          <p className="text-lg text-slate-400 max-w-2xl mx-auto">
            Elevate your style with our curated collection of premium men's sneakers
          </p>
        </div>

        {/* HERO SECTION */}
        <section className={`group relative bg-gradient-to-br from-slate-900/90 to-slate-900/50 backdrop-blur-sm rounded-3xl border border-slate-800/50 overflow-hidden shadow-2xl transition-all duration-1000 ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"} hover:border-slate-700/50 hover:shadow-sky-500/10`}>
          {/* Decorative gradient overlay */}
          <div className="absolute inset-0 bg-gradient-to-br from-sky-500/5 via-transparent to-blue-500/5 pointer-events-none"></div>
          ...
          <div className="relative flex flex-col lg:flex-row gap-8 lg:gap-12 p-8 md:p-12">
            ...
            <div className="flex-1 flex flex-col justify-center space-y-6 z-10">
              ...
              <p className="text-base md:text-lg text-slate-300 leading-relaxed max-w-xl">
                Discover street-ready sneakers and everyday essentials. Find the perfect pair for hoops,
                hangouts, or your next drip photo. Every style crafted for comfort, authenticity, and swagger.
              </p>
              ...
              <div className="flex flex-wrap items-center gap-6 py-4">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <div>
                    ...
                    <div className="text-sm font-bold text-slate-200">Authentic</div>
                  </div>
                </div>
                <div className="flex items-center gap-2">
                  ...
                  <div>
                    ...
                    <div className="text-sm font-bold text-slate-200">Shipping</div>
                  </div>
                </div>
              </div>
              ...
              <div className="flex flex-col sm:flex-row gap-4 pt-2">
                <button
                  ...
                  className="group/btn relative px-8 py-4 bg-gradient-to-r from-sky-500 to-blue-600 text-white font-bold rounded-xl overflow-hidden transition-all duration-300 hover:shadow-2xl hover:shadow-sky-500/50 hover:scale-105"
                >
                ...
                <button
                  onClick={scrollToProducts}
                  className="px-8 py-4 bg-white/5 backdrop-blur-sm border border-white/10 text-slate-200 font-semibold rounded-xl hover:bg-white/10 hover:border-white/20 transition-all duration-300"
                >
                  View All Styles
                </button>
              </div>
            ...
            <div className="flex-1 relative">
              <div className="grid grid-cols-6 grid-rows-6 gap-3 h-[320px] md:h-[400px] lg:h-[480px]">
                ...
                <div className="col-span-3 row-span-6 rounded-2xl overflow-hidden bg-slate-800/50 border border-slate-700/50 relative group/img">
                  <img
                    ...
                    alt="Premium men's sneakers on urban street"
                  ...
                  <div className="absolute bottom-4 left-4 text-white font-bold text-sm opacity-0 group-hover/img:opacity-100 transition-opacity duration-300">
                    Street Ready
                  </div>
                </div>
                ...
                <div className="col-span-3 row-span-3 rounded-2xl overflow-hidden bg-slate-800/50 border border-slate-700/50 relative group/img">
                  <img
                    ...
                    alt="Close-up of streetwear sneakers detail"
                    className="w-full h-full object-cover transition-transform duration-700 group-hover/img:scale-110"
                    loading="lazy"
                  />
                  <div className="absolute inset-0 bg-gradient-to-t from-black/60 via-transparent to-transparent opacity-0 group-hover/img:opacity-100 transition-opacity duration-300"></div>
                  <div className="absolute bottom-3 left-3 text-white font-bold text-xs opacity-0 group-hover/img:opacity-100 transition-opacity duration-300">
                    Premium Details
                  </div>
                </div>
                ...
                <div className="col-span-3 row-span-3 rounded-2xl overflow-hidden bg-slate-800/50 border border-slate-700/50 relative group/img">
                  <img
                    ...
                    alt="Men's sneaker lifestyle shot"
                    className="w-full h-full object-cover transition-transform duration-700 group-hover/img:scale-110"
                    loading="lazy"
                  />
                  <div className="absolute inset-0 bg-gradient-to-t from-black/60 via-transparent to-transparent opacity-0 group-hover/img:opacity-100 transition-opacity duration-300"></div>
              ...
              {/* Floating Badge */}
              <div className="absolute -top-4 -right-4 w-20 h-20 bg-gradient-to-br from-sky-500 to-blue-600 rounded-full flex items-center justify-center shadow-lg shadow-sky-500/50 animate-bounce-slow hidden lg:flex">
                <div className="text-center">
                  <div className="text-white font-black text-lg">NEW</div>
          ...
          {/* Scroll Indicator */}
          <div className="absolute bottom-6 left-1/2 -translate-x-1/2 hidden md:flex flex-col items-center gap-2 text-slate-500 hover:text-sky-400 transition-colors cursor-pointer" onClick={scrollToProducts}>
        ...
        <div className={`mt-8 grid grid-cols-2 md:grid-cols-4 gap-4 transition-all duration-1000 delay-300 ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"}`}>
          {[
            ...
            <div
              key={idx}
              className="bg-slate-900/50 backdrop-blur-sm border border-slate-800/50 rounded-2xl p-4 text-center hover:border-sky-500/30 hover:bg-slate-900/70 transition-all duration-300 group"
            >
        ...
        >
          <div className="mb-8">
            ...
            <p className="text-slate-400 ml-7">
              Browse our complete collection of authentic men's footwear
            </p>
          </div>
